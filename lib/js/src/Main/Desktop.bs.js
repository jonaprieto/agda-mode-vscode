...
var State__StatusBar$AgdaModeVscode = require("../State/State__StatusBar.bs.js");
var Connection__DevALS$AgdaModeVscode = require("../Connection/Download/Connection__DevALS.bs.js");
var State__Diagnostics$AgdaModeVscode = require("../State/State__Diagnostics.bs.js");
...
function activate(context) {
  State__StatusBar$AgdaModeVscode.getOrCreate(context);
  State__Diagnostics$AgdaModeVscode.init();
  return Main$AgdaModeVscode.activate(Desktop, context);
}

function deactivate() {
  State__StatusBar$AgdaModeVscode.destroy();
  State__Diagnostics$AgdaModeVscode.dispose();
  Main$AgdaModeVscode.deactivate();
}
