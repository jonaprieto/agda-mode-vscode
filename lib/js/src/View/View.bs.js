...
function toString$1(x) {
  ...
  switch (x.TAG) {
    ...
    case "SetCompileOutput" :
        return "SetCompileOutput";
    case "SetCompileStatus" :
        return "SetCompileStatus " + (
                x._0 ? "true" : "false"
              );
    case "SetActiveTab" :
        return "SetActiveTab " + Common$AgdaModeVscode.Tab.toString(x._0);
    case "SetCommandPreview" :
        return "SetCommandPreview";
...
var decode$3 = Util$AgdaModeVscode.Decode.sum(function (x) {
      switch (x) {
        ...
        case "SetActiveTab" :
            return {
                    TAG: "Payload",
                    _0: Json_Decode$JsonCombinators.map(Common$AgdaModeVscode.Tab.decode, (function (tab) {
                            return {
                                    TAG: "SetActiveTab",
                                    _0: tab
                                  };
        ...
        case "SetCommandPreview" :
            return {
                    TAG: "Payload",
                    _0: Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.string, (function (preview) {
                            return {
        ...
        case "SetCompileOutput" :
            return {
                    TAG: "Payload",
                    _0: Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.tuple2(Json_Decode$JsonCombinators.array(Json_Decode$JsonCombinators.string), Json_Decode$JsonCombinators.bool), (function (param) {
                            return {
        ...
        case "SetCompileStatus" :
            return {
                    TAG: "Payload",
                    _0: Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.bool, (function (isCompiling) {
                            return {
                                    TAG: "SetCompileStatus",
                                    _0: isCompiling
                                  };
                          }))
                  };
      ...
      switch (x.TAG) {
        ...
        case "SetCompileOutput" :
            return {
                    TAG: "Payload",
                    _0: "SetCompileOutput",
                    _1: Json_Encode$JsonCombinators.tuple2(Json_Encode$JsonCombinators.array(function (prim) {
                                return prim;
                              }), (function (prim) {
                              return prim;
                            }))([
        ...
        case "SetActiveTab" :
            return {
                    TAG: "Payload",
                    _0: "SetActiveTab",
                    _1: Common$AgdaModeVscode.Tab.encode(x._0)
                  };
        case "SetCommandPreview" :
            return {
                    TAG: "Payload",
                    _0: "SetCommandPreview",
                    _1: x._0
                  };
  ...
  if (typeof x !== "object") {
    ...
    switch (x.TAG) {
      ...
      case "JumpToTarget" :
          return "JumpToTarget";
      case "TabChanged" :
          return "TabChanged " + Common$AgdaModeVscode.Tab.toString(x._0);
      case "CompileRequested" :
          return "CompileRequested";
      case "CompileOptionsChanged" :
          return "CompileOptionsChanged";
      case "RunBinaryRequested" :
          return "RunBinaryRequested " + x._0;
      case "AgdaFlagsChanged" :
          return "AgdaFlagsChanged";
      case "CommandRequested" :
          return "CommandRequested " + x._0;
...
var decode$9 = Util$AgdaModeVscode.Decode.sum(function (x) {
      switch (x) {
        case "AgdaFlagsChanged" :
            return {
                    TAG: "Payload",
                    _0: Json_Decode$JsonCombinators.map(Common$AgdaModeVscode.AgdaFlags.decode, (function (flags) {
                            return {
                                    TAG: "AgdaFlagsChanged",
                                    _0: flags
                                  };
                          }))
                  };
        case "CommandRequested" :
            return {
                    TAG: "Payload",
                    _0: Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.string, (function (cmd) {
                            return {
                                    TAG: "CommandRequested",
                                    _0: cmd
                                  };
                          }))
                  };
        case "CompileOptionsChanged" :
            return {
                    TAG: "Payload",
                    _0: Json_Decode$JsonCombinators.map(Common$AgdaModeVscode.CompileOptions.decode, (function (opts) {
                            return {
                                    TAG: "CompileOptionsChanged",
                                    _0: opts
                                  };
                          }))
                  };
        ...
        case "RunBinaryRequested" :
            return {
                    TAG: "Payload",
                    _0: Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.tuple2(Json_Decode$JsonCombinators.string, Json_Decode$JsonCombinators.string), (function (param) {
                            return {
                                    TAG: "RunBinaryRequested",
                                    _0: param[0],
                                    _1: param[1]
                                  };
                          }))
        ...
        switch (x.TAG) {
          ...
          case "CompileRequested" :
              return {
                      TAG: "Payload",
                      _0: "CompileRequested",
                      _1: Common$AgdaModeVscode.CompileOptions.encode(x._0)
                    };
          case "CompileOptionsChanged" :
              return {
                      TAG: "Payload",
                      _0: "CompileOptionsChanged",
                      _1: Common$AgdaModeVscode.CompileOptions.encode(x._0)
                    };
          case "RunBinaryRequested" :
              return {
                      TAG: "Payload",
                      _0: "RunBinaryRequested",
                      _1: Json_Encode$JsonCombinators.tuple2((function (prim) {
                                return prim;
                              }), (function (prim) {
                                return prim;
                              }))([
          ...
          case "AgdaFlagsChanged" :
              return {
                      TAG: "Payload",
                      _0: "AgdaFlagsChanged",
                      _1: Common$AgdaModeVscode.AgdaFlags.encode(x._0)
                    };
          case "CommandRequested" :
              return {
                      TAG: "Payload",
